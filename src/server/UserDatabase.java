...
public class UserDatabase {
    ...
    public final String URL_MYSQL = "jdbc:mysql://localhost:3306/chat_db";
    ...
    public Connection connect() {
        try {
            ...
            System.out.println("Error connection! Lỗi kết nối!");
...
//            System.out.println("[LỖI!] primary key '"+u.name+"' đã tồn tại, ko thểm thêm bản ghi này!");
    ...
    public void setLoginTime(String name) {
        try {
            ...
            pst = conn.prepareStatement("update "+USER_TABLE+" set login = '"+sToday+"' where name = '" + name + "'");
            rs = pst.executeQuery();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("============");
        ud.connect();
        ud.insertUser(new User("TRG", "1234"));
        ud.showData();
    }
}
